...
import 'package:tv_shows_tmdb/screens/drawer_screen.dart';
import 'package:tv_shows_tmdb/screens/finder_screen.dart';
import 'package:tv_shows_tmdb/services/movie.dart';
import 'package:tv_shows_tmdb/utils/constants.dart';
import 'package:tv_shows_tmdb/utils/file_manager.dart' as file;
import 'package:tv_shows_tmdb/utils/navi.dart' as navi;
import 'package:tv_shows_tmdb/utils/scroll_top_with_controller.dart'
    as scrollTop;
import 'package:tv_shows_tmdb/utils/toast_alert.dart' as alert;
import 'package:tv_shows_tmdb/widgets/bottom_navigation.dart';
import 'package:tv_shows_tmdb/widgets/bottom_navigation_item.dart';
import 'package:tv_shows_tmdb/widgets/custom_loading_spin_kit_ring.dart';
import 'package:tv_shows_tmdb/widgets/custom_main_appbar_content.dart';
import 'package:tv_shows_tmdb/widgets/tv_show_card.dart';
import 'package:tv_shows_tmdb/widgets/tv_show_card_container.dart';
import 'package:tv_shows_tmdb/widgets/shadowless_floating_button.dart';
...
class HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  List<MovieCard>? _tVShowCards;
  bool showSlider = true;
  String title = kHomeScreenTitleText;
  int bottomBarIndex = 1;

  Future<void> loadData() async {
    MovieModel tVShowModel = MovieModel();
    _tVShowCards = (bottomBarIndex == 1)
        ? await tVShowModel.getMovies(
        moviesType: MoviePageType.values[activeInnerPageIndex!],
            themeColor: themeColor!)
        : await tVShowModel.getFavorites(
  ...
  Widget build(BuildContext context) {
    return (themeColor == null)
        ...
        : Scaffold(
            ...
            body: (_tVShowCards == null)
                ? CustomLoadingSpinKitRing(loadingColor: themeColor)
                : (_tVShowCards!.length == 0)
                    ? Center(child: Text(k404Text))
                    : MovieCardContainer(
                        scrollController: _scrollController!,
                        themeColor: themeColor!,
                        movieCards: _tVShowCards!,
                      ),
