...
import 'package:tv_shows_tmdb/utils/star_calculator.dart'
    as starCalculator;
...
class DetailsScreen extends StatefulWidget {
  ...
  Future<TVShowDetails> getmDetails() async {
    MovieModel tVShowModel = MovieModel();
    TVShowDetails temp = await tVShowModel.getMovieDetails(movieID: id);
    return temp;
  }
}
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void initState() {
    super.initState();
    () async {
      TVShowDetails temp = await widget.getmDetails();
      List<Widget> temp2 =
  ...
  saveFavorite() async {
    if (await file.addFavorite(tvSID: widget.id)) {
      alert.toastAlert(
  ...
  removeFavorite() async {
    if (await file.removeFavorite(tvSID: widget.id)) {
      alert.toastAlert(
