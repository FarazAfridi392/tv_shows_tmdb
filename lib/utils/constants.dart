...
import 'package:tv_shows_tmdb/screens/home_screen.dart';
import 'package:sizer/sizer.dart';

final GlobalKey<HomeScreenState> kHomeScreenKey = GlobalKey();

const kThemoviedbURL = "https://api.themoviedb.org/3/tv";
const kThemoviedbSearchURL = "https://api.themoviedb.org/3/search/tv";
const kThemoviedbImageURL = "https://image.tmdb.org/t/p/w300";
const kHomeScreenButtonFirstText = "Populars";
const kHomeScreenButtonSecondText = "Airing Today";
const kHomeScreenButtonThirdText = "Top Rated";
const kHomeScreenTitleText = "Watch Now";
const k404Text = "TV Shows not found";
const kFavoriteRemovedText = "TV Show removed from Favorites";
const kFavoriteAddedText = "TV Show added to Favorites";
...
const kDrawerAboutDescText =
    "Hi, I am Faraz Afridi. This is my solution to the test";
